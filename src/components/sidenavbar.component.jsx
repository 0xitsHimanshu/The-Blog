        ...
        <>
            <section className='relative flex gap-10 py-0 m-0 max-md:flex-col'>
                <div className='sticky top-[80px] z-30'>
                    ...
                    {/* parent div below  */}
                    <div className={'min-w-[200px] h-[calc(100vh-80px-60px)] h-cover md:sticky top-24 overflow-y auto p-6 md:pr-0 md: border-grey md: border-r absolute max-md:top-[64px] bg-white max-md:w-[calc(100%+80px)] max-md: px-16 max-md:-ml-7 duration-500 '+ (!showSideNav ? "max-md:opacity-0 pointer-events-none ": "max-md:opacity-100 pointer-events-auto")}>
